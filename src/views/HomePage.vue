    ...
    data() {
      return {
        ...
        questions: [
          ...
          { question: "Як зрозуміти, яка активність зараз запущена?", answer: "Запущена активність буде мати активний таймер та активну позначку біля активності.", showAnswer: false },
          { question: "Як переглянути загальну кількість годин за день?", answer: "Перейдіть до розділу 'Звітність', щоб переглянути деталі.", showAnswer: false },
          { question: "Як користуватись фільтрами?", answer: "Щоб переглянути фільтр за місяцями, потрібно очистити фільтр за днем, для перегляду дня потрібно обрати 'Всі місяці' у відповідному фільтрі.", showAnswer: false }
        ]
      }
    },
    mounted() {
